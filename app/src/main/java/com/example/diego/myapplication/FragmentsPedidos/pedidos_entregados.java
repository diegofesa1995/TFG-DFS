...
public class pedidos_entregados extends Fragment {
  ...
  /*      Query dbPedidos = FirebaseDatabase.getInstance().getReference().child("Pedidos").orderByChild("Estado").equalTo("Entregado");
